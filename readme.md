...
The scripts are written in Python3 using different packages namely Python3, NumPy, matplotlib, pandas, os, math, and re.
...
- combined_summary
- active_hits.csv - summarized the active samples having high antimicrobial activity
...
This is part of the prerequisite of BIO_539.